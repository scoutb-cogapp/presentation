...
[extra]
images = [
  { src = "images/placeholder.svg", alt = "xxx" },
  { src = "images/placeholder.svg", alt = "xxx" },
  { src = "images/placeholder.svg", alt = "xxx" },
  { src = "images/placeholder.svg", alt = "xxx" },
  { src = "images/placeholder.svg", alt = "xxx" },
...
The grid is a fixed 3x3 layout. List up to 9 images in `images` in the frontmatter, each with its own `src` and `alt`; they fill the grid left to right, top to bottom, and empty cells stay empty. Set `image_first` to `true` or `false` in the frontmatter, same as the image + text layout.
